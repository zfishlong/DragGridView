package com.ilmare.draggridview.view;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (mDragPosition == AdapterView.INVALID_POSITION) {   //不合法的位置  拦截掉
